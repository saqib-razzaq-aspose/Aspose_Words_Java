...
package com.aspose.words.examples.prog_docs;
...
public class FindAndHighlight
{
    public static void main(String[] args) throws Exception
    {
        ...
        Document doc = new Document(dataDir + "FindAndHighlight.doc");
        ...
        doc.save(dataDir + "FindAndHighlight Out.doc");

        System.out.println("Saved the document after highlighting the text at " + dataDir + "FindAndHighlight Out.doc");
    }
}
